...
const Home = () => {
  ...
  return (
    <div className='flex flex-col relative'>
      <Navbar/>
      <div className='flex flex-row w-full h-screen bg-bg-primary items-center justify-center pt-[10vh] gap-20'>
