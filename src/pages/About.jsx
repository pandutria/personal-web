...
const About = () => {
  ...
  return (
    <div className="flex flex-col">
      <Navbar />
      <div className="flex flex-col w-full h-screen pt-[6vh] bg-bg-primary items-center justify-center">
        ...
        <div className="flex flex-row pt-15">
            <div className="flex flex-col gap-6">
              {/* <h1 className="font-poppins font-medium text-third text-[25px]">Interested in learning more about me?</h1> */}
              <div className="flex flex-col">
